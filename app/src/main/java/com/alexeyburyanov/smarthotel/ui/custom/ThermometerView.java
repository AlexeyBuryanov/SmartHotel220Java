...
public class ThermometerView extends View {
    ...
    private static final int GRADUATION_TEXT_SIZE = 9; // in sp
    private static float DEGREE_WIDTH = 30;
    private static final int NB_GRADUATIONS = 8;
    public static final float MAX_TEMP = 30, MIN_TEMP = 0;
    private static final float RANGE_TEMP = 35;
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        graduationPaint.setTextSize(ViewUtils.dpToPx(GRADUATION_TEXT_SIZE));
